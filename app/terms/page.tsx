    ...
    <div className="min-h-screen bg-slate-50 p-6">
      <div className="max-w-2xl mx-auto bg-white p-8 rounded-2xl shadow-sm border border-slate-200">
        ...
        <div className="prose prose-slate text-slate-600">
          ...
          <p>By creating an account on DriveTrack, you agree to these terms. If you do not agree, you must not use the app.</p>

          <h3>2. Educational Aid Only</h3>
          <p>DriveTrack is a progress tracking tool. The "Readiness Score" and skill logs are estimates based on instructor input. They do not guarantee a pass result in any official driving test.</p>
